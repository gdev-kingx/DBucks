...
import { sendRandomETH } from "@/lib/contract"; // Import functions from the contract.ts file
...
export default function RewardsPage() {
	...
	const handleSendETH = async () => {
		...
		setStatus("Sending random ETH...");
		try {
			await sendRandomETH(recipient);
			setStatus("Transaction complete!");
		} catch (err) {
			setStatus("Error sending ETH");
		}
	};
	...
	const rewardTiers: RewardTier[] = [
		{
			...
			description:
				"Perfect for deep focus and meditation. Earn tokens in quiet environments.",
		},
		{
			name: "Study Hall",
			minDb: 31,
			...
			description:
				"Ideal for focused learning and reading. Moderate background noise.",
		},
		{
			name: "Classroom",
			minDb: 51,
			...
			description:
				"Active learning environment with discussions and collaboration.",
		},
		{
			name: "Workshop",
			minDb: 71,
			...
			description:
				"High-energy environment for practical learning and group work.",
		},
	];
			...
			<div className="container mx-auto px-4 pt-20">
				...
				<div className="text-center mb-12">
					...
					<p className="text-xl text-gray-300 max-w-2xl mx-auto">
						Transform your learning environment into rewards.
						Monitor sound levels, maintain optimal study conditions,
						and earn EDU tokens.
					</p>
				</div>
				...
				<div className="bg-white/5 backdrop-blur-lg rounded-xl p-8 mb-8 border border-white/10">
					<div className="flex items-center justify-between mb-6">
						<div>
							...
							<p className="text-gray-400">
								Your sound levels influence your rewards
							</p>
						</div>
						<button
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						...
						<div className="bg-black/30 rounded-lg p-6 border border-white/5">
							...
							<p className="text-3xl font-bold">
								{currentTier?.name || "Not in range"}
							</p>
							<p className="text-sm text-gray-400 mt-1">
								{currentTier
									? `${currentTier.tokensPerHour} EDU/hour`
									: "Start tracking to earn"}
							</p>
						</div>
				...
				<div className="bg-white/5 backdrop-blur-lg rounded-xl p-8 mb-8 border border-white/10">
					...
					<div className="mb-4 flex flex-col">
						<input
							...
							className="w-[600px] p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
						/>
						<button
							onClick={handleSendETH}
							className="bg-purple-500 text-white py-2 px-4 rounded-lg hover:bg-purple-600 transition-colors mt-4 w-[200px]"
						>
							Send Random ETH
						</button>
					</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
					{rewardTiers.map((tier) => (
						...
						>
							<div
								className={`absolute inset-0 bg-gradient-to-r ${tier.color} opacity-5 rounded-lg group-hover:opacity-10 transition-opacity`}
							/>
							...
							<div className="space-y-2">
								...
								<div className="pt-2 border-t border-white/5">
									<p className="text-sm text-gray-400">
										Range: {tier.minDb} - {tier.maxDb} dB
									</p>
				...
				<div className="text-center max-w-2xl mx-auto">
					...
					<div className="space-y-4 text-gray-300">
						<p>
							DBucks EDU rewards you for maintaining optimal
							learning environments. Different sound levels
							correspond to different learning contexts, each with
							its own reward rate.
						</p>
						<p>
							Start tracking to begin earning EDU tokens. The
							quieter and more conducive your environment is for
							learning, the more tokens you earn. Use these tokens
							for educational resources and special features.
						</p>
					</div>
				</div>
			</div>
